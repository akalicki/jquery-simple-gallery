...
this._changeToImg(this.nextImg)},stopAnimation:function(){this.options.animate=!1;d.clearTimeout(this.cycle);this.element.stop(!0);this._endTransition()},resumeAnimation:function(){var a=this;a.options.animate=!0;a.cycle=d.setTimeout(function(){a._loadNext()},a.options.waitTime)}})})(jQuery,window,document);